        ...
        <Tabs value="0">
            ...
            <TabPanels>
                <TabPanel value="0">
                    ...
                    <ul>
                        <li class="border-b py-3 px-5 flex flex-col" v-for="(factory, index) in factories" :key="index" >
                ...
                <TabPanel value="1">
                    <div class="">
                        ...
                        <ul>
                            <li class="border-b py-3 px-5 flex flex-col" v-for="(outsource, index) in outsourcelist" :key="index" >
