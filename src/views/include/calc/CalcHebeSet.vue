    ...
    <div class="flex flex-col gap-8 py-4">
        ...
        <div class="grid grid-cols-4 gap-3">
            <IftaLabel>
                ...
                <InputText v-keyfilter.money inputmode="numeric" id="bWidth" v-model="esti['common']['width']" class="w-full text-lg" @update:modelValue="esti.getUnitCalc()"/>
                <small class="whitespace-nowrap text-msg">{{ esti['msg']['blind']['bWidth'] }}</small>
            </IftaLabel> 
            <IftaLabel>
                <label>세로 (CM)<span class="ml-0.5 text-red-500">*</span></label>
                <InputText v-keyfilter.money inputmode="numeric" id="bHeight" v-model="esti['common']['height']" class="w-full text-lg" @update:modelValue="esti.getUnitCalc()"/>
