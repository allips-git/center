    ...
    <div class="flex flex-col h-full">
        ...
        <div class="flex flex-1 h-[calc(100%-var(--header-height))]">
            <SideHeader 
                ...
                :drawerClass="false"
            />
            <div class="overflow-hidden z-0 flex-1 w-full">
                <div class="overflow-y-auto h-full xl:bg-gray-100" :class="pageBackgroundClass">
                    <div
                        class="flex justify-center w-full min-h-full" 
